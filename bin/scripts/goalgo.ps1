...
Start-Process "chrome.exe" -ArgumentList "https://etherpad.wikimedia.org/p/Algoritmi$((Get-Date).ToString('yyyyMMdd'))"
...
Write-Host "Collaborative etherpad Algoritmi URL: https://etherpad.wikimedia.org/p/Algoritmi$((Get-Date).ToString('yyyyMMdd'))"
